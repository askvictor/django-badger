...
class Migration(SchemaMigration):
    ...
    def _forwards_create(self, orm):
        ...
        db.create_table(self.new_table_name, (
            ...
            ('nominee', self.gf('django.db.models.fields.related.ForeignKey')(related_name='nomination_nominee', to=orm[user_orm_label])),
            ('accepted', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('creator', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='nomination_creator', null=True, to=orm[user_orm_label])),
            ('approver', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='nomination_approver', null=True, to=orm[user_orm_label])),
