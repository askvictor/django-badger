...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Badge.wb_image'
        db.add_column('badger_badge', 'wb_image',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Badge.wb_image'
        db.delete_column('badger_badge', 'wb_image')
    ...
    models = {
        ...
        'badger.badge': {
            ...
            'wb_image': ('django.db.models.fields.files.ImageField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'})
        },
        'badger.deferredaward': {
            'Meta': {'ordering': "['-modified', '-created']", 'object_name': 'DeferredAward'},
            'badge': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['badger.Badge']"}),
            'claim_code': ('django.db.models.fields.CharField', [], {'default': "'xac73n'", 'unique': 'True', 'max_length': '32', 'db_index': 'True'}),
